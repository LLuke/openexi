...
final class SimpleContentGrammar extends ElementContentGrammar {
  ...
  private final ArrayEventTypeList m_eventTypes_0; // may include CH, PI, Comments, etc.
  private final ArrayEventTypeList m_eventTypes_1; // may include CH, PI, Comments, etc.
