...
import org.openexi.fujitsu.proc.EXISchemaResolver;
...
public final class EXIReader implements XMLReader, Attributes {
  ...
  private void reset() {
    ...
    pushNamespaceDeclaration(PREFIXES[0], URIConst.W3C_XML_1998_URI);
  }
        ...
        case EXIEvent.EVENT_SE: {
          ...
          if (exiEvent != null && exiEvent.getEventVariety() == EXIEvent.EVENT_TP) {
            if (preserveNS) {
              ...
              int i;
              for (i = m_n_namespaceDeclarations - 1; i > -1; i--)  {
                if (URIConst.W3C_2001_XMLSCHEMA_INSTANCE_URI.equals(m_namespaceDeclarationsLocus[i << 1 | 1]))
                    break;
              }
              if (i == -1) {
                attrPrefix = m_n_namespaceDeclarations < PREFIXES.length ? PREFIXES[m_n_namespaceDeclarations] :
                  "p" + m_n_namespaceDeclarations;
                m_contentHandler.startPrefixMapping(attrPrefix, URIConst.W3C_2001_XMLSCHEMA_INSTANCE_URI);
                pushNamespaceDeclaration(attrPrefix, URIConst.W3C_2001_XMLSCHEMA_INSTANCE_URI);
              }
            ...
            addAttribute(URIConst.W3C_2001_XMLSCHEMA_INSTANCE_URI, "type", attrQualifiedName, "", typeQualifiedName);
            exiEvent = scanner.nextEvent();
          }
          if (exiEvent != null && exiEvent.getEventVariety() == EXIEvent.EVENT_NL) {
            ...
            addAttribute(URIConst.W3C_2001_XMLSCHEMA_INSTANCE_URI, "nil", attrQualifiedName, "", preserveLexicalValues ? 
