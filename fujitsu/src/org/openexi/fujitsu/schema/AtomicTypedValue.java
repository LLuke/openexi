...
public final class AtomicTypedValue extends TypedValue {
  ...
  private final int m_primTypeId; // primitive type identifier
  private Object m_variant; // typed value
  ...
  public boolean equals(Object obj) {
    if (super.equals(obj) && obj instanceof AtomicTypedValue) {
      ...
      if (this.m_primTypeId == EXISchemaConst.BASE64BINARY_TYPE && that.m_primTypeId == EXISchemaConst.BASE64BINARY_TYPE ||
          this.m_primTypeId == EXISchemaConst.HEXBINARY_TYPE && that.m_primTypeId == EXISchemaConst.HEXBINARY_TYPE) {
        ...
        return m_variant.equals(((AtomicTypedValue)obj).m_variant);
    }
    return false;
  }
