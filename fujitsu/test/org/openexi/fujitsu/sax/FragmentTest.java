...
import org.openexi.fujitsu.proc.grammars.BuiltinGrammar;
...
import org.openexi.fujitsu.proc.io.Apparatus;
  ...
  public void testElementFragmentStrict_04() throws Exception {
    ...
    for (AlignmentType alignment : Alignments) {
      ...
      Assert.assertEquals(EXISchemaConst.DECIMAL_TYPE, 
          corpus.getSerialOfType(corpus.getPrimitiveTypeOfAtomicSimpleType(nd)));
