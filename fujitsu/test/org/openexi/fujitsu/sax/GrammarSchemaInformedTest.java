...
import org.openexi.fujitsu.proc.grammars.GrammarAccessor;
import org.openexi.fujitsu.proc.grammars.GrammarCache;
import org.openexi.fujitsu.proc.grammars.GroupGrammar;
import org.openexi.fujitsu.proc.grammars.SchemaInformedGrammar;
...
import org.openexi.fujitsu.scomp.Docbook43Schema;
  ...
  public void testOpenGisExample01() throws Exception {
    ...
    for (AlignmentType alignment : Alignments) {
      for (boolean preserveWhitespaces : new boolean[] { true, false }) {
        ...
        Assert.assertEquals(URIConst.W3C_XML_1998_URI, uriPartition.getString(1));
        Assert.assertEquals(URIConst.W3C_2001_XMLSCHEMA_INSTANCE_URI, uriPartition.getString(2));
        Assert.assertEquals(URIConst.W3C_2001_XMLSCHEMA_URI, uriPartition.getString(3));
