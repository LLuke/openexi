...
public class PrefixPartitionTest extends TestCase {
  ...
  public void testXmlPrefixes() throws Exception {
    ...
    prefixPartition = stringTable.getPrefixPartition(URIConst.W3C_XML_1998_URI);
  ...
  public void testXsiPrefixes() throws Exception {
    ...
    prefixPartition = stringTable.getPrefixPartition(URIConst.W3C_2001_XMLSCHEMA_INSTANCE_URI);
  ...
  public void testXsdPrefixes() throws Exception {
    ...
    prefixPartition = stringTable.getPrefixPartition(URIConst.W3C_2001_XMLSCHEMA_URI);
