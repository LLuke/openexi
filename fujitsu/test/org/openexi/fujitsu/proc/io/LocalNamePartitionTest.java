...
public class LocalNamePartitionTest extends TestCase {
  ...
  public void testXmlNames() throws Exception {
    ...
    localNamePartition = stringTable.getLocalNamePartition(URIConst.W3C_XML_1998_URI);
  ...
  public void testXsiNames() throws Exception {
    ...
    localNamePartition = stringTable.getLocalNamePartition(URIConst.W3C_2001_XMLSCHEMA_INSTANCE_URI);
  ...
  public void testXsdNames() throws Exception {
    ...
    localNamePartition = stringTable.getLocalNamePartition(URIConst.W3C_2001_XMLSCHEMA_URI);
