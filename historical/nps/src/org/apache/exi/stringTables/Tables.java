...
public class Tables {
    ...
    public void deleteLocalValues(int level){
        // list of the local names for this level in the document
        StringTable levelTable = localNameDefinedLevel.get(level);
        // how many local names are at this level
        int levelSize = levelTable.getSize();       

        // for each local name, delete the local values...out of scope
...
//                }
        ...
        //StringTable aTable = localValueTables.get("a localName");
    }
     ...
     * @param value
     */
    public int addStringToLocalValue(String localname, String value) //throws StringNotFoundException
    {
        // make sure value is not too big to add
        ...
        // make sure the value table is not too big
    ...
    public void addStringToLocalNameTable(String localname, int level) {
        if (!localNameStringTable.stringExists(localname)) {
            ...
            //************** ADD THE LOCAL NAME, LEVLE MAPPING HERE...where in
            // document this localname was defined for scope control
            StringTable levelTable = localNameDefinedLevel.get(level);
            if(levelTable == null){
