        ...
        if (epos < i_len) {
              ...
              if (XmlUriConst.W3C_2001_XMLSCHEMA_INSTANCE_URI.equals(attrs.getURI(i))) {
                ...
                if ("type".equals(instanceName)) {
                    ...
                    switch (itemType = eventType.itemType) {
                      ...
                      case EventCode.ITEM_AT:
                        ...
                        if ("type".equals(eventType.getName()) && 
                            XmlUriConst.W3C_2001_XMLSCHEMA_INSTANCE_URI.equals(eventType.getURI())) {
                          break iterateEventTypes;
                        }
                        break;
                    }
                  ...
                  te = new TransmogrifierException(TransmogrifierException.UNEXPECTED_ATTR, 
                      new String[] { "type", XmlUriConst.W3C_2001_XMLSCHEMA_INSTANCE_URI  }, new LocatorImpl(m_locator));
          ...
          if (positionOfType != -1) {
            ...
            if (!isSchemaInformedGrammar && (itemType = eventTypeForType.itemType) == EventCode.ITEM_AT_WC_ANY_UNTYPED) {
              m_documentState.undeclaredAttribute(XmlUriConst.W3C_2001_XMLSCHEMA_INSTANCE_URI, "type");
            }
          ...
          if (positionOfNil != -1) {
            ...
            if (isSchemaInformedGrammar) {
              ...
              if (i == i_len) {
                TransmogrifierException te;
                te = new TransmogrifierException(TransmogrifierException.UNEXPECTED_ATTR, 
                    new String[] { "nil", XmlUriConst.W3C_2001_XMLSCHEMA_INSTANCE_URI  }, new LocatorImpl(m_locator));
                throw new SAXException(te);
              }
            }
            if (nilled != null) {
              ...
              if (isSchemaInformedGrammar) {
                ...
                m_scriber.writeQName(qname.setValue(XmlUriConst.W3C_2001_XMLSCHEMA_INSTANCE_URI, "nil", 
                    hasNS ? getPrefixOfQualifiedName(attrs.getQName(positionOfNil)) : null), itemType);
                m_stringValueScriber.scribe(nilval, m_scribble, "nil", XmlUriConst.W3C_2001_XMLSCHEMA_INSTANCE_URI, EXISchema.NIL_NODE);
                --n_attrs;
              }
              else {
