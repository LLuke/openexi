...
public final class EXIOptionsEncoder {
  ...
  public BitOutputStream encode(EXIOptions options, boolean outputSchemaId, OutputStream ostream) throws IOException {
    ...
    m_scriber.writeEventType(eventType);
    m_documentState.startElement(0, ExiUriConst.W3C_2009_EXI_URI, "header");
    eventTypes = m_documentState.getNextEventTypes();
    ...
    if ((delineation & EXIOptions.ADD_LESSCOMMON) != 0) {
      ...
      m_scriber.writeEventType(eventType);
      m_documentState.startElement(0, ExiUriConst.W3C_2009_EXI_URI, "lesscommon");
      eventTypes = m_documentState.getNextEventTypes();
      int pos_level2 = 0;
      if ((delineation & EXIOptions.ADD_UNCOMMON) != 0) {
        ...
        m_scriber.writeEventType(eventType);
        m_documentState.startElement(0, ExiUriConst.W3C_2009_EXI_URI, "uncommon");
        eventTypes = m_documentState.getNextEventTypes();
        int pos_level3 = 0;
        if ((delineation & EXIOptions.ADD_ALIGNMENT) != 0) {
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(0, ExiUriConst.W3C_2009_EXI_URI, "alignment");
          eventTypes = m_documentState.getNextEventTypes();
          final String name;
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, name);
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.item(0);
          assert eventType.itemType == EventCode.ITEM_SCHEMA_EE;
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, name);
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.getEE();
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "alignment");
          eventTypes = m_documentState.getNextEventTypes();
        }
        if ((delineation & EXIOptions.ADD_VALUE_MAX_LENGTH) != 0) {
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "valueMaxLength");
          eventTypes = m_documentState.getNextEventTypes();
          m_valueScriberUnsignedInt.processUnsignedInt(options.getValueMaxLength(), m_scribble);
          m_valueScriberUnsignedInt.scribe((String)null, m_scribble, "valueMaxLength", ExiUriConst.W3C_2009_EXI_URI, m_unsignedIntType);
          m_documentState.characters();
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.getEE();
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "valueMaxLength");
          eventTypes = m_documentState.getNextEventTypes();
        }
        if ((delineation & EXIOptions.ADD_VALUE_PARTITION_CAPACITY) != 0) {
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "valuePartitionCapacity");
          eventTypes = m_documentState.getNextEventTypes();
          m_valueScriberUnsignedInt.processUnsignedInt(options.getValuePartitionCapacity(), m_scribble);
          m_valueScriberUnsignedInt.scribe((String)null, m_scribble, "valuePartitionCapacity", ExiUriConst.W3C_2009_EXI_URI, m_unsignedIntType);
          m_documentState.characters();
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.getEE();
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "valuePartitionCapacity");
          eventTypes = m_documentState.getNextEventTypes();
        }
        if ((delineation & EXIOptions.ADD_DTRM) != 0) {
          ...
          for (int i = 0; i < n_dtrmItems; i++, pos = 0) {
            ...
            m_scriber.writeEventType(eventType);
            m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "datatypeRepresentationMap");
            eventTypes = m_documentState.getNextEventTypes();
            qname = dtrm[i << 1];
            eventType = eventTypes.item(0);
            ...
            eventType = eventTypes.getEE();
            m_scriber.writeEventType(eventType);
            m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "datatypeRepresentationMap");
            eventTypes = m_documentState.getNextEventTypes();
          }
        }
        eventType = eventTypes.getEE();
        m_scriber.writeEventType(eventType);
        m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "uncommon");
        eventTypes = m_documentState.getNextEventTypes();
      }
      if ((delineation & EXIOptions.ADD_PRESERVE) != 0) {
        ...
        m_scriber.writeEventType(eventType);
        m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "preserve");
        eventTypes = m_documentState.getNextEventTypes();
        int pos_level3 = 0;
        if (options.getPreserveDTD()) {
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(0, ExiUriConst.W3C_2009_EXI_URI, "dtd");
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.getEE();
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "dtd");
          eventTypes = m_documentState.getNextEventTypes();
        }
        if (options.getPreserveNS()) {
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "prefixes");
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.getEE();
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "prefixes");
          eventTypes = m_documentState.getNextEventTypes();
        }
        if (options.getPreserveLexicalValues()) {
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "lexicalValues");
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.getEE();
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "lexicalValues");
          eventTypes = m_documentState.getNextEventTypes();
        }
        /**
        ...
        if (options.getPreserveComments()) {
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "comments");
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.getEE();
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "comments");
          eventTypes = m_documentState.getNextEventTypes();
        }
        if (options.getPreservePIs()) {
          ...
          m_scriber.writeEventType(eventType);
          m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "pis");
          eventTypes = m_documentState.getNextEventTypes();
          eventType = eventTypes.getEE();
          m_scriber.writeEventType(eventType);
          m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "pis");
          eventTypes = m_documentState.getNextEventTypes();
        }
        eventType = eventTypes.getEE();
        m_scriber.writeEventType(eventType);
        m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "preserve");
        eventTypes = m_documentState.getNextEventTypes();
      }
      int blockSize;
      if ((blockSize = options.getBlockSize()) != EXIOptions.BLOCKSIZE_DEFAULT) {
        ...
        m_scriber.writeEventType(eventType);
        m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "blockSize");
        eventTypes = m_documentState.getNextEventTypes();
        m_valueScriberUnsignedInt.processUnsignedInt(blockSize, m_scribble);
        m_valueScriberUnsignedInt.scribe((String)null, m_scribble, "blockSize", ExiUriConst.W3C_2009_EXI_URI, m_unsignedIntType);
        m_documentState.characters();
        eventTypes = m_documentState.getNextEventTypes();
        eventType = eventTypes.getEE();
        m_scriber.writeEventType(eventType);
        m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "blockSize");
        eventTypes = m_documentState.getNextEventTypes();
      }
      eventType = eventTypes.getEE();
      m_scriber.writeEventType(eventType);
      m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "lesscommon");
      eventTypes = m_documentState.getNextEventTypes();
    }
    if ((delineation & EXIOptions.ADD_COMMON) != 0) {
      ...
      m_scriber.writeEventType(eventType);
      m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "common");
      eventTypes = m_documentState.getNextEventTypes();
      int pos_level2 = 0;
      if (alignmentType == AlignmentType.compress) {
        ...
        m_scriber.writeEventType(eventType);
        m_documentState.startElement(0, ExiUriConst.W3C_2009_EXI_URI, "compression");
        eventTypes = m_documentState.getNextEventTypes();
        eventType = eventTypes.getEE();
        m_scriber.writeEventType(eventType);
        m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "compression");
        eventTypes = m_documentState.getNextEventTypes();
      }
      if (options.isFragment()) {
        ...
        m_scriber.writeEventType(eventType);
        m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "fragment");
        eventTypes = m_documentState.getNextEventTypes();
        eventType = eventTypes.getEE();
        m_scriber.writeEventType(eventType);
        m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "fragment");
        eventTypes = m_documentState.getNextEventTypes();
      }
      ...
      if (outputSchemaId && (schemaId = options.getSchemaId()) != null) {
        ...
        m_scriber.writeEventType(eventType);
        m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "schemaId");
        eventTypes = m_documentState.getNextEventTypes();
        String val;
        if ((val = schemaId.getValue()) == null) {
          ...
          m_scriber.getValueScriberByID(Scriber.CODEC_STRING).scribe(
              val, m_scribble, "schemaId", ExiUriConst.W3C_2009_EXI_URI, ((EventTypeSchema)eventType).getSchemaSubstance());
          m_documentState.characters();
          eventTypes = m_documentState.getNextEventTypes();
        }
        eventType = eventTypes.getEE();
        m_scriber.writeEventType(eventType);
        m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "schemaId");
        eventTypes = m_documentState.getNextEventTypes();
      }
      eventType = eventTypes.getEE();
      m_scriber.writeEventType(eventType);
      m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "common");
      eventTypes = m_documentState.getNextEventTypes();
    }
    if (options.isStrict()) {
      pos = 2 - pos_level1;
      ...
      m_scriber.writeEventType(eventType);
      m_documentState.startElement(pos, ExiUriConst.W3C_2009_EXI_URI, "strict");
      eventTypes = m_documentState.getNextEventTypes();
      eventType = eventTypes.getEE();
      m_scriber.writeEventType(eventType);
      m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "strict");
      eventTypes = m_documentState.getNextEventTypes();
    }
    eventType = eventTypes.getEE();
    m_scriber.writeEventType(eventType);
    m_documentState.endElement(ExiUriConst.W3C_2009_EXI_URI, "header");
    eventTypes = m_documentState.getNextEventTypes();
