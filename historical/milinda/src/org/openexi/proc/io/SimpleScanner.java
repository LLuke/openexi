...
import org.openexi.proc.events.EXIEventElement;
import org.openexi.proc.events.EXIEventAttributeByValue;
import org.openexi.proc.events.EXIEventUndeclaredElement;
import org.openexi.proc.events.EXIEventComment;
import org.openexi.proc.events.EXIEventSchemaMixedCharactersByValue;
import org.openexi.proc.events.EXIEventProcessingInstruction;
import org.openexi.proc.events.EXIEventWildcardStartElement;
import org.openexi.proc.events.EXIEventUndeclaredCharactersByValue;
import org.openexi.proc.events.EXIEventSchemaNil;
import org.openexi.proc.events.EXIEventEntityReference;
import org.openexi.proc.events.EXIEventWildcardAttributeByValue;
import org.openexi.proc.events.EXIEventSchemaCharactersByValue;
    ...
    switch (itemType = eventType.itemType) {
      ...
      case EventCode.ITEM_AT:
        ...
        if (itemType == EventCode.ITEM_AT && "type".equals(qname.localName) && 
            XmlUriConst.W3C_2001_XMLSCHEMA_INSTANCE_URI.equals(qname.namespaceName)) {
