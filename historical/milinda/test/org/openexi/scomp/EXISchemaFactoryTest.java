...
public class EXISchemaFactoryTest extends TestCase {
  ...
  public void testElement() throws Exception {
    ...
    Assert.assertEquals(EXISchema.PARTICLE_NODE,
                      corpus.getNodeType(opaques[heads]));
    int elem_b = corpus.getTermOfParticle(opaques[heads]);
    Assert.assertEquals(EXISchema.ELEMENT_NODE, corpus.getNodeType(elem_b));
    Assert.assertEquals("B", corpus.getNameOfElem(elem_b));
    Assert.assertEquals(EXISchema.PARTICLE_NODE,
                      corpus.getNodeType(opaques[heads + 1]));
    int elem_c = corpus.getTermOfParticle(opaques[heads + 1]);
  ...
  public void testTypeSimpleType() throws Exception {
    ...
    Assert.assertEquals(_string, corpus.getBaseTypeOfAtomicSimpleType(str10type));
    ...
    Assert.assertEquals(EXISchemaConst.STRING_TYPE, corpus.getAncestryIdOfSimpleType(str10type));

    int str16type = corpus.getTypeOfNamespace(foons, "string16");
    Assert.assertEquals(_string, corpus.getBaseTypeOfAtomicSimpleType(str16type));
    Assert.assertEquals(EXISchemaConst.STRING_TYPE, corpus.getAncestryIdOfSimpleType(str16type));

    int str3_10type = corpus.getTypeOfNamespace(foons, "string3_10");
    int _str10type = corpus.getBaseTypeOfAtomicSimpleType(str3_10type);
    Assert.assertEquals(str10type, _str10type);
    Assert.assertEquals(EXISchemaConst.STRING_TYPE, corpus.getAncestryIdOfSimpleType(str3_10type));

    int foo_a = corpus.getElemOfNamespace(foons, "A");
    Assert.assertEquals(_anySimpleType, corpus.getTypeOfElem(foo_a));

    int str16list = corpus.getTypeOfNamespace(foons, "strings16");
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getBaseTypeOfAtomicSimpleType(str16list));
    ...
    Assert.assertEquals(EXISchemaConst.STRING_TYPE, corpus.getAncestryIdOfSimpleType(collapsedString));
  }
  ...
  public void testTypeComplexType() throws Exception {
    ...
    Assert.assertEquals("urn:foo", corpus.getTargetNamespaceNameOfType(datedString));
  ...
  public void testAttributeUse() throws Exception {
    ...
    Assert.assertEquals(useOfAuthor, corpus.getOpaques()[nextAttrUses1]);
    Assert.assertEquals(1, corpus.getOpaques()[nextAttrUses1 + 1]);
    ...
    Assert.assertEquals(useOfDate, corpus.getOpaques()[nextAttrUses1]);
    Assert.assertEquals(useOfExpired, corpus.getOpaques()[nextAttrUses1 + 1]);
    Assert.assertEquals(useOfObsolete, corpus.getOpaques()[nextAttrUses1 + 2]);
    Assert.assertEquals(useOfPublished, corpus.getOpaques()[nextAttrUses1 + 3]);
    Assert.assertEquals(useOfQName, corpus.getOpaques()[nextAttrUses1 + 4]);
    Assert.assertEquals(useOfType, corpus.getOpaques()[nextAttrUses1 + 5]);
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getOpaques()[nextAttrUses1 + 6]);
    Assert.assertEquals(2, corpus.getOpaques()[nextAttrUses1 + 7]);
    Assert.assertEquals(3, corpus.getOpaques()[nextAttrUses1 + 8]);
    Assert.assertEquals(4, corpus.getOpaques()[nextAttrUses1 + 9]);
    Assert.assertEquals(5, corpus.getOpaques()[nextAttrUses1 + 10]);
    Assert.assertEquals(6, corpus.getOpaques()[nextAttrUses1 + 11]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 12]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 13]);
    ...
    Assert.assertEquals(useOfExpired, corpus.getOpaques()[nextAttrUses1]);
    Assert.assertEquals(useOfObsolete, corpus.getOpaques()[nextAttrUses1 + 1]);
    Assert.assertEquals(useOfPublished, corpus.getOpaques()[nextAttrUses1 + 2]);
    Assert.assertEquals(useOfQName, corpus.getOpaques()[nextAttrUses1 + 3]);
    Assert.assertEquals(useOfType, corpus.getOpaques()[nextAttrUses1 + 4]);
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getOpaques()[nextAttrUses1 + 5]);
    Assert.assertEquals(3, corpus.getOpaques()[nextAttrUses1 + 6]);
    Assert.assertEquals(4, corpus.getOpaques()[nextAttrUses1 + 7]);
    Assert.assertEquals(5, corpus.getOpaques()[nextAttrUses1 + 8]);
    Assert.assertEquals(6, corpus.getOpaques()[nextAttrUses1 + 9]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 10]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 11]);
    ...
    Assert.assertEquals(useOfObsolete, corpus.getOpaques()[nextAttrUses1]);
    Assert.assertEquals(useOfPublished, corpus.getOpaques()[nextAttrUses1 + 1]);
    Assert.assertEquals(useOfQName, corpus.getOpaques()[nextAttrUses1 + 2]);
    Assert.assertEquals(useOfType, corpus.getOpaques()[nextAttrUses1 + 3]);
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getOpaques()[nextAttrUses1 + 4]);
    Assert.assertEquals(4, corpus.getOpaques()[nextAttrUses1 + 5]);
    Assert.assertEquals(5, corpus.getOpaques()[nextAttrUses1 + 6]);
    Assert.assertEquals(6, corpus.getOpaques()[nextAttrUses1 + 7]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 8]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 9]);
    ...
    Assert.assertEquals(useOfPublished, corpus.getOpaques()[nextAttrUses1]);
    Assert.assertEquals(useOfQName, corpus.getOpaques()[nextAttrUses1 + 1]);
    Assert.assertEquals(useOfType, corpus.getOpaques()[nextAttrUses1 + 2]);
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getOpaques()[nextAttrUses1 + 3]);
    Assert.assertEquals(5, corpus.getOpaques()[nextAttrUses1 + 4]);
    Assert.assertEquals(6, corpus.getOpaques()[nextAttrUses1 + 5]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 6]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 7]);
    ...
    Assert.assertEquals(useOfQName, corpus.getOpaques()[nextAttrUses1]);
    Assert.assertEquals(useOfType, corpus.getOpaques()[nextAttrUses1 + 1]);
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getOpaques()[nextAttrUses1 + 2]);
    Assert.assertEquals(6, corpus.getOpaques()[nextAttrUses1 + 3]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 4]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 5]);
    ...
    Assert.assertEquals(useOfType, corpus.getOpaques()[nextAttrUses1 ]);
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getOpaques()[nextAttrUses1 + 1]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 2]);
    Assert.assertEquals(7, corpus.getOpaques()[nextAttrUses1 + 3]);
  }
  ...
  public void testListItemType() throws Exception {
    ...
    Assert.assertEquals(_decimal, corpus.getBaseTypeOfAtomicSimpleType(decimal8));

    int decimal4 = corpus.getTypeOfNamespace(foons, "decimal4");
    Assert.assertEquals(decimal8, corpus.getBaseTypeOfAtomicSimpleType(decimal4));

    int listOfDecimal8 = corpus.getTypeOfNamespace(foons, "listOfDecimal8");
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getBaseTypeOfAtomicSimpleType(listOfDecimal8));
    Assert.assertEquals(EXISchema.LIST_SIMPLE_TYPE,
    ...
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getBaseTypeOfAtomicSimpleType(listOfDecimal4));
    Assert.assertEquals(EXISchema.LIST_SIMPLE_TYPE,
  ...
  public void testUnion() throws Exception {
    ...
    int unionedEnum = corpus.getTypeOfNamespace(foons, "unionedEnum");
    Assert.assertEquals(2, corpus.getMemberTypesCountOfUnionSimpleType(unionedEnum));
    Assert.assertEquals(_int, corpus.getMemberTypeOfUnionSimpleType(unionedEnum, 0));
    Assert.assertEquals(_NMTOKEN, corpus.getMemberTypeOfUnionSimpleType(unionedEnum, 1));
  }
  ...
  public void testUnionOfUnion() throws Exception {
    ...
    Assert.assertEquals(3, corpus.getMemberTypesCountOfUnionSimpleType(unionOfUnion));
    int m1 = corpus.getMemberTypeOfUnionSimpleType(unionOfUnion, 0);
    Assert.assertEquals(EXISchema.SIMPLE_TYPE_NODE, corpus.getNodeType(m1));
    Assert.assertEquals(corpus.getBuiltinTypeOfSchema(EXISchemaConst.NMTOKEN_TYPE), corpus.getBaseTypeOfAtomicSimpleType(m1));
    ...
    int m2 = corpus.getMemberTypeOfUnionSimpleType(unionOfUnion, 1);
    ...
    int m3 = corpus.getMemberTypeOfUnionSimpleType(unionOfUnion, 2);
  ...
  public void testListOfUnion() throws Exception {
    ...
    Assert.assertEquals(2, corpus.getMemberTypesCountOfUnionSimpleType(union));
    int m1 = corpus.getMemberTypeOfUnionSimpleType(union, 0);
    Assert.assertEquals(EXISchema.SIMPLE_TYPE_NODE, corpus.getNodeType(m1));
    Assert.assertEquals(EXISchemaConst.INTEGER_TYPE, corpus.getSerialOfType(m1));
    int m2 = corpus.getMemberTypeOfUnionSimpleType(union, 1);
    Assert.assertEquals(EXISchema.SIMPLE_TYPE_NODE, corpus.getNodeType(m2));
  ...
  public void testMinMaxOccursOfParticle() throws Exception {
    ...
    Assert.assertEquals(particle, opaques[corpus.getMemberSubstanceListOfGroup(group)]);
  ...
  public void testSubstantialMaxOccursOfParticle()
    ...
    substanceParticle = opaques[list + 0];
    ...
    substanceParticle = opaques[list + 1];
    ...
    substanceParticle = opaques[list + 2];
    ...
    substanceParticle = opaques[list + 3];
    ...
    substanceParticle = opaques[list + 4];
  ...
  public void testSubstantialMaxOccursOfParticleWithConflict()
    ...
    substanceParticle1 = opaques[list];
    ...
    substanceParticle2 = opaques[list];
  ...
  public void testNestedGroupReference_01() throws Exception {
    ...
    Assert.assertEquals(p_item, corpus.getOpaques()[corpus.getHeadSubstanceListOfGroup(g_group)]);

    Assert.assertEquals(2, corpus.getHeadSubstanceCountOfGroup(g_group, 0));
    list = corpus.getHeadSubstanceListOfGroup(g_group, 0);
    Assert.assertEquals(p_item, corpus.getOpaques()[list]);
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getOpaques()[list + 1]);
    Assert.assertEquals(1, corpus.getHeadSubstanceCountOfGroup(g_group, 1));
    list = corpus.getHeadSubstanceListOfGroup(g_group, 1);
    Assert.assertEquals(EXISchema.NIL_NODE, corpus.getOpaques()[list]);
    
    Assert.assertEquals(1, corpus.getHeadSubstanceCountOfGroup(g_hoge));
    Assert.assertEquals(p_item, corpus.getOpaques()[corpus.getHeadSubstanceListOfGroup(g_hoge)]);
  ...
  public void testComplexTypeParticles_Sequence_01() throws Exception {
    ...
    Assert.assertEquals(0, opaques[substances + 2]); // particle index within the group
    
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[substances + 1]);
    Assert.assertEquals(2, opaques[substances + 3]); // particle index within the group
  }
  ...
  public void testComplexTypeParticles_Sequence_02() throws Exception {
    ...
    Assert.assertEquals(EXISchema.PARTICLE_NODE, corpus.getNodeType(pB));
    Assert.assertEquals("B", corpus.getNameOfElem(corpus.getTermOfParticle(pB)));
    Assert.assertEquals(0, opaques[substances + 3]); // particle index within the group

    int pC = opaques[substances + 1];
    ...
    Assert.assertEquals(1, opaques[substances + 4]); // particle index within the group
    
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[substances + 2]);
    Assert.assertEquals(2, opaques[substances + 5]); // particle index within the group
  }
  ...
  public void testComplexTypeParticles_Choice_07() throws Exception {
    ...
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[substances]);
    Assert.assertEquals(0, opaques[substances + 1]); // particle index within the group
  }
  ...
  public void testComplexTypeParticles_Empty_01() throws Exception {
    ...
    int substances = corpus.getSubstanceListOfComplexType(ctype);
    Assert.assertTrue(substances != EXISchema.NIL_NODE);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[substances + 0]);
    Assert.assertEquals(0, opaques[substances + 1]); // particle index within the group
  ...
  public void testStateTableSequence() throws Exception {
    ...
    Assert.assertEquals(s1_pb, opaques[list]);
    Assert.assertEquals(0, opaques[list + 1]);
    ...
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list]);
    Assert.assertEquals(1, opaques[list + 1]);
    ...
    Assert.assertEquals(s2_pb, opaques[list]);
    Assert.assertEquals(0, opaques[list + 2]);
    Assert.assertEquals(s2_pc, opaques[list + 1]);
    Assert.assertEquals(1, opaques[list + 3]);
    ...
    Assert.assertEquals(s3_pb, opaques[list]);
    Assert.assertEquals(0, opaques[list + 1]);

    Assert.assertEquals(2, corpus.getHeadSubstanceCountOfGroup(group_s3));
    list2 = corpus.getHeadSubstanceListOfGroup(group_s3);
    Assert.assertEquals(s3_pb, opaques[list2]);
    Assert.assertEquals(0, opaques[list2 + 2]);
    int s3_pc = opaques[list2 + 1];
    ...
    Assert.assertEquals(1, opaques[list2 + 3]);
    ...
    Assert.assertEquals(s3_pc, opaques[list]);
    Assert.assertEquals(1, opaques[list + 1]);
  ...
  public void testStateTableSequence02() throws Exception {
    ...
    Assert.assertEquals(s6_pa, opaques[list]);
    Assert.assertEquals(0, opaques[list + 4]);
    Assert.assertEquals(s6_pb, opaques[list + 1]);
    Assert.assertEquals(1, opaques[list + 5]);
    Assert.assertEquals(s6_pc, opaques[list + 2]);
    Assert.assertEquals(2, opaques[list + 6]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 3]);
    Assert.assertEquals(3, opaques[list + 7]);
    ...
    Assert.assertEquals(s6_pb, opaques[list]);
    Assert.assertEquals(1, opaques[list + 3]);
    Assert.assertEquals(s6_pc, opaques[list + 1]);
    Assert.assertEquals(2, opaques[list + 4]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 2]);
    Assert.assertEquals(3, opaques[list + 5]);
    ...
    Assert.assertEquals(s6_pc, opaques[list]);
    Assert.assertEquals(2, opaques[list + 2]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 1]);
    Assert.assertEquals(3, opaques[list + 3]);
  }
  ...
  public void testStateTableSequence03() throws Exception {
    ...
    Assert.assertEquals(s7_pa, opaques[list]);
    Assert.assertEquals(0, opaques[list + 5]);
    Assert.assertEquals(s7_pb, opaques[list + 1]);
    Assert.assertEquals(1, opaques[list + 6]);
    Assert.assertEquals(s7_pc, opaques[list + 2]);
    Assert.assertEquals(2, opaques[list + 7]);
    Assert.assertEquals(s7_pd, opaques[list + 3]);
    Assert.assertEquals(2, opaques[list + 8]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 4]);
    Assert.assertEquals(3, opaques[list + 9]);
    ...
    Assert.assertEquals(s7_pb, opaques[list]);
    Assert.assertEquals(1, opaques[list + 4]);
    Assert.assertEquals(s7_pc, opaques[list + 1]);
    Assert.assertEquals(2, opaques[list + 5]);
    Assert.assertEquals(s7_pd, opaques[list + 2]);
    Assert.assertEquals(2, opaques[list + 6]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 3]);
    Assert.assertEquals(3, opaques[list + 7]);
    ...
    Assert.assertEquals(s7_pc, opaques[list]);
    Assert.assertEquals(2, opaques[list + 3]);
    Assert.assertEquals(s7_pd, opaques[list + 1]);
    Assert.assertEquals(2, opaques[list + 4]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 2]);
    Assert.assertEquals(3, opaques[list + 5]);
  }
  ...
  public void testStateTableSequenceNested() throws Exception {
    ...
    Assert.assertEquals("B", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list])));
    Assert.assertEquals("C", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list + 1])));
    Assert.assertEquals("D", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list + 2])));
    Assert.assertEquals("E", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list + 3])));
    Assert.assertEquals("F", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list + 4])));
    Assert.assertEquals(0, opaques[list + 5]);
    Assert.assertEquals(1, opaques[list + 6]);
    Assert.assertEquals(1, opaques[list + 7]);
    Assert.assertEquals(2, opaques[list + 8]);
    Assert.assertEquals(2, opaques[list + 9]);

    Assert.assertEquals(6, corpus.getHeadSubstanceCountOfGroup(group_s4));
    list2 = corpus.getHeadSubstanceListOfGroup(group_s4);
    Assert.assertEquals("B", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list2])));
    Assert.assertEquals("C", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list2 + 1])));
    Assert.assertEquals("D", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list2 + 2])));
    Assert.assertEquals("E", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list2 + 3])));
    Assert.assertEquals("F", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list2 + 4])));
    Assert.assertEquals("G", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list2 + 5])));
    Assert.assertEquals(0, opaques[list2 + 6]);
    Assert.assertEquals(1, opaques[list2 + 7]);
    Assert.assertEquals(1, opaques[list2 + 8]);
    Assert.assertEquals(2, opaques[list2 + 9]);
    Assert.assertEquals(2, opaques[list2 + 10]);
    Assert.assertEquals(3, opaques[list2 + 11]);
    ...
    Assert.assertEquals("G", corpus.getNameOfElem(
        corpus.getTermOfParticle(opaques[list])));
    Assert.assertEquals(3, opaques[list + 1]);
    ...
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list]);
    Assert.assertEquals(4, opaques[list + 1]);
  }
  ...
  public void testStateTableChoice() throws Exception {
    ...
    Assert.assertEquals("B", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list])));
    ...
    Assert.assertEquals("B", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list])));
    Assert.assertEquals(0, opaques[list + 2]);
    Assert.assertEquals("C", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 1])));
    Assert.assertEquals(1, opaques[list + 3]);
    ...
    Assert.assertEquals("C", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list])));
    Assert.assertEquals(1, opaques[list + 2]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 1]);
    Assert.assertEquals(2, opaques[list + 3]);
  ...
  public void testStateTableChoiceNested() throws Exception {
    ...
    Assert.assertEquals("B", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list])));
    Assert.assertEquals("C", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 1])));
    Assert.assertEquals("D", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 2])));
    Assert.assertEquals("E", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 3])));
    Assert.assertEquals("F", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 4])));
    Assert.assertEquals("G", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 5])));
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 6]);
    Assert.assertEquals(0, opaques[list + 7]);
    Assert.assertEquals(1, opaques[list + 8]);
    Assert.assertEquals(1, opaques[list + 9]);
    Assert.assertEquals(2, opaques[list + 10]);
    Assert.assertEquals(2, opaques[list + 11]);
    Assert.assertEquals(3, opaques[list + 12]);
    Assert.assertEquals(4, opaques[list + 13]);
    ...
    Assert.assertEquals(0, opaques[list + 2]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 1]);
    Assert.assertEquals(4, opaques[list + 3]);
    ...
    Assert.assertEquals("C", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 0])));
    Assert.assertEquals(1, opaques[list + 3]);
    Assert.assertEquals("D", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 1])));
    Assert.assertEquals(1, opaques[list + 4]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 2]);
    Assert.assertEquals(4, opaques[list + 5]);
    ...
    Assert.assertEquals("E", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 0])));
    Assert.assertEquals(2, opaques[list + 3]);
    Assert.assertEquals("F", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 1])));
    Assert.assertEquals(2, opaques[list + 4]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 2]);
    Assert.assertEquals(4, opaques[list + 5]);
    ...
    Assert.assertEquals("G", corpus.getNameOfElem(corpus.getTermOfParticle(opaques[list + 0])));
    Assert.assertEquals(3, opaques[list + 2]);
    Assert.assertEquals(EXISchema.NIL_NODE, opaques[list + 1]);
    Assert.assertEquals(4, opaques[list + 3]);
...
//    Assert.assertEquals(1, nodes[list + 1]);
  ...
  public void testIncludeSchemaChameleon_01() throws Exception {
    ...
    Assert.assertEquals(2, corpus.getMemberTypesCountOfUnionSimpleType(unionedString));

    int string10 = corpus.getMemberTypeOfUnionSimpleType(unionedString, 0);
    ...
    int nmtoken = corpus.getMemberTypeOfUnionSimpleType(unionedString, 1);
  ...
  public void testEmptyGroup01() throws Exception {
    ...
    Assert.assertEquals(EXISchema.NIL_NODE,
                      EXISchema._getHeadSubstanceListOfParticle(particle, corpus.getNodes()));
  ...
  public void testPrimerIPOSchemas() throws Exception {
    ...
    // Assert.assertEquals(_address, corpus.getBaseTypeOfSimpleType(_usAddress));
    ...
    // REVISIT: It does not work! FIX.
    // Assert.assertEquals(_usAddress, corpus.getBaseTypeOfSimpleType(_ukAddress));
  }
  ...
  public void testCBMSSchema() throws Exception {
    ...
    int m2 = corpus.getMemberTypeOfUnionSimpleType(unionOfUnion, 1);
    Assert.assertEquals(EXISchema.SIMPLE_TYPE_NODE, corpus.getNodeType(m2));
    Assert.assertEquals(corpus.getBuiltinTypeOfSchema(EXISchemaConst.NMTOKEN_TYPE), corpus.getBaseTypeOfAtomicSimpleType(m2));
    int m3 = corpus.getMemberTypeOfUnionSimpleType(unionOfUnion, 2);
    Assert.assertEquals(EXISchema.SIMPLE_TYPE_NODE, corpus.getNodeType(m3));
    Assert.assertEquals(corpus.getBuiltinTypeOfSchema(EXISchemaConst.ANYURI_TYPE), corpus.getBaseTypeOfAtomicSimpleType(m3));
  ...
  public void testSOAPAddressing() throws Exception {
    ...
    Assert.assertEquals(pValue, opaques[headInstances]);
  ...
  public void testFragment_01() throws Exception {
    ...
    Assert.assertEquals("urn:goo", EXISchema._getTargetNamespaceNameOfElem(fragmentINode, nodes, uris)); 
    ...
    Assert.assertEquals("urn:foo", EXISchema._getTargetNamespaceNameOfElem(fragmentINode, nodes, uris)); 
    Assert.assertTrue(EXISchema._isSpecificINodeInFragment(fragmentINode, nodes));
